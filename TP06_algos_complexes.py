...
# Les tests rapides d'abord.
#if __name__ == '__main__': testeur.fais_tests('07_pascal2')

# Puis ceux qui prennent un peu plus de temps pour tester l'efficacite de l'algorithme choisi.
#if __name__ == '__main__': testeur.fais_tests('08_pascal2_long')
...
# Ligne suivante a decommenter pour tester
#if __name__ == '__main__': testeur.fais_tests('09_squarefree')
...
# Ligne suivante a decommenter pour tester
#if __name__ == '__main__': testeur.fais_tests('10_triangle')
